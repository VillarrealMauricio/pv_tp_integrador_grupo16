...
function App() {
  return (
    <>
      <Routes>
        <Route path="/login" element={<h2 className="text-center mt-5">Pantalla de Login</h2>} />
        <Route path="/" element={<Layout />}>
          ...
          <Route path="clientes/:id" element={<h2 className="container">Ficha Profunda (Módulo D)</h2>} />
        </Route>
      </Routes>
    </>
  );
